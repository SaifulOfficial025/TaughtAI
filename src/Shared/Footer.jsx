        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-300 leading-relaxed mt-2 max-w-xs mx-auto md:mx-0">
              Helping schools unlock the potential of their staff through
              effective AI CPD and programmes.
            </p>
          </div>
          ...
          <div className="md:pl-8 text-center md:text-left">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>
                <Link to="/tryourplatform" className="hover:text-white">
                  Try Our Platform
                </Link>
              </li>
              <li>
          ...
          {/* Contact / Right (center on mobile, right on md+) */}
          <div className="text-center md:text-right">
            ...
            <div className="flex flex-col items-center md:items-end gap-3 text-gray-300">
              ...
              <div className="flex items-center gap-3 justify-center md:justify-end">
                ...
                <a
                  href="mailto:ben@taughtai.co.uk"
