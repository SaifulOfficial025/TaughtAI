  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div
          className="mx-auto bg-white border rounded-2xl p-10 shadow-sm"
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl text-gray-900 leading-snug mt-10">
              "43% rated their AI confidence at 3/10 or lower"
              <br />
            </h2>
            <p className="mt-4 text-xl text-black font-bitter">
              thecpd.group, 2025
            </p>

            <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl text-gray-900 leading-snug mt-10">
              “60% requested more training.”
              <br />
            </h2>
            <p className="mt-4 text-xl text-black font-bitter">
              thecpd.group, 2025
            ...
            <div className="mt-8">
              <a
                href="#"
                className="inline-block bg-gray-800 text-white px-6 py-2 rounded-full shadow-sm"
              >
                Learn More
              </a>
            </div>
      ...
      {/* Our Ethos section */}
      <section className="bg-[#f3f3f3] px-10">
        <div className="mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <a
              href="#"
              className="inline-block bg-gray-800 text-white px-6 py-2 rounded-full shadow-sm text-xl"
            >
              Learn More
            </a>
          </div>
          ...
          <div className="flex justify-end">
            <img
              src={ethos}
              alt="Our ethos"
              className="w-full max-w-sm md:max-w-md rounded-xl object-cover shadow"
            />
          </div>
        </div>
      </section>
