    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 font-bitter text-md sm:text-sm  md:text-2xl text-gray-200 max-w-3xl mx-auto px-2 sm:px-0">
            Stay informed with the latest news, expert insights, and educational
            resources from Taught AI. Our blog provides valuable content to help
            you harness the power of AI in education.
          </p>
        </div>
      </div>
    </section>
