  ...
  return (
    <section className="py-12 max-w-7xl mx-auto px-6 mt-10">
      <div className="mx-auto ">
        <h2 className="text-center text-3xl md:text-5xl font-playfair font-bold mb-8">How I Help Schools</h2>

        {/* Row 1: Training & CPD (text left, image right) */}
        <div className="grid grid-cols-1 md:grid-cols-2 items-stretch ">
          <div className="order-2 md:order-1 bg-[#f1f5f9] p-6 sm:p-8 h-48 sm:h-64 md:h-72 lg:h-80 overflow-y-auto">
            <h3 className="text-2xl sm:text-3xl font-playfair font-semibold mb-3">Training & CPD</h3>
            <p className="text-base sm:text-2xl font-bitter text-gray-700 leading-relaxed">
          ...
          <div className="order-1 md:order-2">
            <div className="w-full h-48 sm:h-64 md:h-72 lg:h-80 bg-gray-100 rounded-sm overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-stretch ">
          ...
          <div className="bg-[#f1f5f9] p-6 sm:p-8 h-48 sm:h-64 md:h-72 lg:h-80 overflow-y-auto">
            <h3 className="text-2xl sm:text-3xl font-playfair font-semibold mb-3">Policy Alignment</h3>
            <p className="text-base sm:text-2xl font-bitter text-gray-700 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-stretch ">
          <div className="bg-[#f1f5f9] p-6 sm:p-8 h-48 sm:h-64 md:h-72 lg:h-80 overflow-y-auto">
            <h3 className="text-2xl sm:text-3xl font-playfair font-semibold mb-3">Practical Implementation</h3>
            <p className="text-base sm:text-2xl font-bitter text-gray-700 leading-relaxed">
