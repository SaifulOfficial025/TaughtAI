...
const tools = [
  {
    ...
    short: 'Designs inclusive, Ofsted-aligned schemes of work—structured by week, with clear objectives, assessment points, and delivery strategies.',
    bullets: [
      'Specify subject, phase, and context (e.g. “8-week English grammer catch up for low-literacy learners”).',
  ...
  },
  {
    ...
    short: 'Generates fully structured, Ofsted-aligned lesson plans tailored to your subject, pupil needs, and curriculum goals.',
    bullets: [
  ...
  },
  {
    ...
    short: 'Creates engaging, curriculum-linked worksheets, activities, and tasks tailored to your class’s needs, interests, and learning levels.',
    bullets: [
      ...
      'Use it to adapt content around pupil interests—like music, sport, or beauty—to boost engagement.'
    ]
  },
  {
    title: 'Communication Improver GPT',
    short: 'Helps staff draft professional, trauma-informed emails and structure supportive conversations with parents and external professionals—aligned with safeguarding, SEND, and inclusion policies.',
    bullets: [
      ...
      'Request formats like bullet points, phone scripts, or sentence starters.',
      'Use follow-ups like “make this clearer,” “simplify for parents,” or “align with school policy language.”'
    ]
  },
  {
    title: 'Behaviour and classroom strategies',
    short: 'Provides instant access to researched strategies for behaviour, learning needs, and classroom challenges—tailored to your school context.',
    bullets: [
  ...
  },
  {
    ...
    short: 'Supports senior leaders by generating evidence-informed summaries, policies, improvement actions, and inspection prep—aligned with school values, Ofsted expectations, and national guidance.',
    bullets: [
      ...
      'Ask for specific formats like summaries, policy lines, CPD slides, or SIP actions.',
      'Use follow-up prompts like “align this with EIF” or “adapt for governor review.”'
    ]
  }
]
...
<div className="min-h-screen  text-gray-900 font-sans">
  <div className="max-w-6xl mx-auto ">
    ...
    <div className="bg-white rounded-lg  ">
      <div className="grid md:grid-cols-2 items-start bg-[#fbf4ea] ">
        <div className='py-10 px-6 md:px-10 '>
          <h1 className="text-3xl lg:text-4xl font-serif font-bold leading-tight">
            AI Use Guidance for <br /> Taught AI Primary Staff
          </h1>
          ...
          {idx % 2 === 0 ? (
            <>
              <div className="bg-gray-900 text-white rounded-none py-12 px-8 flex flex-col justify-center items-start font-playfair ">
                ...
                <div className="mt-4">
                    <button onClick={() => navigate('/chats')} className="bg-white text-gray-900 px-6 py-2.5 text-sm font-semibold rounded-full  hover:bg-gray-100 transition">
                      Launch
                    </button>
                </div>
              </div>
            ...
            <>
              {/* Even (white left) */}
              <div className="bg-[#fff7ed] rounded-none py-12 px-8 order-last md:order-first font-bitter">
